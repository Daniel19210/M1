...
import sd.akka.actor.TelActor;

public class App {
    public static void main(String[] args) {
        ActorSystem actorSystem = ActorSystem.create();
        String message = "Arbitrairement";
        ActorRef telActor = actorSystem.actorOf(TelActor.props(10));
        telActor.tell(new TelActor.ChangeString(message), ActorRef.noSender());
         ...
         * CompletionStage<Object> result = Patterns.ask(arbitreActor, new
         * ArbitreActor.StartGame(), Duration.ofSeconds(10));
         * try {
         ...
         * On démarre un pool de 5 acteurs du même type, et on route les messages avec
         * une stratégie round robin
         */
        /*
         * ActorRef router = actorSystem.actorOf(new
         * RoundRobinPool(5).props(NombrePremierActor.props()));
         * for (int i = 3; i < 10; i++) {
