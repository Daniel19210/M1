...
let rec tri_insertion_brut liste =
	match liste with
	| [] -> []
	| elt1::reste -> insere_dans_liste_triee elt1 (tri_insertion_brut reste) ;;
...
tri_insertion_brut liste_a_trier ;;
